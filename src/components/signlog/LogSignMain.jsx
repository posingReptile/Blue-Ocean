...
function LogSignMain({ setComponent, setLoggedUser }) {
  ...
  const currComponent = (loginComponent) => {
    switch (loginComponent) {
      case 'logsign' :
        return (<LogSign setLoggedUser={setLoggedUser} username={username} setUsername={setUsername} password={password} setPassword={setPassword}setLoginComponent={setLoginComponent} setComponent={setComponent}/>);
      case 'usersetup' :
